...
*Vue js documentation scoped slots diagram*:
...
>**⚠️ WARNING**
> Slots *name* attribute won't be included in the props because it is reserved
...
<script setup>
	...
	const text = "But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system."
</script>
